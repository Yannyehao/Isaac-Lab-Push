...
class CommandsCfg:
    ...
    object_pose = mdp.UniformPoseCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            pos_x=(0.3, 0.6), pos_y=(-0.3, 0.3), pos_z=(0.0, 0.0), roll=(0.0, 0.0), pitch=(0.0, 0.0), yaw=(0.0, 0.0)
        ),
    )
    ...
    object3_pose = mdp.UniformPoseCommandCfg(
        asset_name="robot",
        body_name=MISSING,  # will be set by agent env cfg
        resampling_time_range=(10.0, 10.0),
        debug_vis=True,
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Add object3 position in robot root frame
        object3_position = ObsTerm(func=mdp.object3_position_in_robot_root_frame)
        target3_object3_position = ObsTerm(func=mdp.generated_commands, params={"command_name": "object3_pose"})
...
class EventCfg:
    ...
    """This EventCfg controls the randomization of the object position."""

    reset_all = EventTerm(func=mdp.reset_scene_to_default, mode="reset")
    
    # reset the position of the object1
    ...
    # reset the position of the object2
    ...
    # reset the position of the object3
...
class RewardsCfg:
    ...
    object_goal_tracking_fine_grained = RewTerm(
        func=mdp.object_goal_distance,
        params={"std": 0.01, "command_name": "object_pose"},
        weight=5,
    )
    ...
    object2_goal_tracking = RewTerm(
        ...
        params={"std": 0.15,  "command_name": "object2_pose"},
        weight=16.0,
    )

    object2_goal_tracking_fine_grained = RewTerm(
        func=mdp.object2_goal_distance,
        params={"std": 0.01, "command_name": "object2_pose"},
        weight=5,
    )
    
    reaching_object3 = RewTerm(func=mdp.object3_ee_distance, params={"std": 0.5}, weight=4.0)


    object3_goal_tracking = RewTerm(
        func=mdp.object3_goal_distance,
        params={"std": 0.15,  "command_name": "object3_pose"},
        weight=16.0,
    )

    object3_goal_tracking_fine_grained = RewTerm(
        func=mdp.object3_goal_distance,
        params={"std": 0.01, "command_name": "object3_pose"},
        weight=5,
    )
...
#     reaching_object = RewTerm(func=mdp.object_ee_distance, params={"std": 0.5}, weight=0.148)
...
@configclass
class Push3EnvCfg(ManagerBasedRLEnvCfg):
